        ...
        <>
          {
            <div className="infoDiabetic">
              ...
              <div className="preventDiabetes">
                <p>
                  {" "}
                  These tips can help you feel happier, healthier, and more
                  hopeful.
                </p>
                <ul className={{ fontSize: "12px" }}>
                ...
                <p>
                  Seek professional help ,needing additional help doesn’t mean
                  you’re weak. Sometimes the negative thinking in depression can
                  make you feel like you’re a lost cause, but depression can be
                  treated and you can feel better! Don’t forget about these
                  self-help tips, though. Even if you’re receiving professional
                  help, these tips can be part of your treatment plan, speeding
          ...
          <div className="center">
            <div id="register">
              <div className="d-flex flex-column">
                <div className="d-flex flex-row customLabel align-items-start">

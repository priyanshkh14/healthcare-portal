                    ...
                    <>

                        {
                            <div className='infoDiabetic'>
                                <h2 style={{ color: 'orange', fontFamily: 'Bebas Neue', fontSize: '70px' }}>{result}</h2>
                            ...
                            <div id='register'>
                                ...
                                <div className='d-flex flex-column'>
                                    ...
                                    <div className='d-flex flex-row'>
                                        <select className='custominputField' name={questions[pos].name} value={buttonClick ? data : ('', reset())} onChange={handleChange} type={questions[pos].type}  >
                                    ...
                                    {submitButton ? '' : <button className='customSubmitButton' onClick={submitHandler}>SUBMIT</button>}
                                </div>

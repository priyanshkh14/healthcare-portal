...
export default function PCOSPrediction() {
  ...
  var questions = [
    {
      question: "Pulse rate(bpm)",
      option: {},
      type: "text",
      name: "pulseRate",
    },
    {
      question: "Respiration Rate(breath/min)",
      option: {},
      type: "text",
      name: "respRate",
    },
    {
      question: "Regularity of menstrual Cycle (Regular/irregular)",
      option: {},
      type: "text",
      name: "cycle",
    },
    {
      question: "Menstrual Cycle length",
      option: {},
      type: "text",
      name: "cycleLength",
    },
    {
      question: "measurement of hip(inch)",
      option: {},
      type: "text",
      name: "hip",
    },
    ...
    {
      question: "measurement of waist(inch)",
      option: {},
      type: "text",
      name: "waist",
    },
    {
      question: "Are you Gaining weight recently (Yes/No)",
      option: {},
      type: "text",
      name: "weightGain",
    },
    ...
    {
      question: "Is your hair growth normal (Yes/no)",
      option: {},
      type: "text",
      name: "hairGrowth",
    },
    {
      question: "Are you experiencing skin Darkening (Yes/No)",
      option: {},
      type: "text",
      name: "skinDark",
    },
    {
      question: "Are you facing Hairfall issues (Yes/No)",
      option: {},
      type: "text",
      name: "hairFall",
    },
    {
      question: "Are you getting lot of pimples(Yes/no)",
      option: {},
      type: "text",
      name: "pimple",
    },
    {
      question: "Do you eat junk food a lot?(Yes/No)",
      option: {},
      type: "text",
      name: "fastfood",
    },
  ...
  function submitHandler() {
    ...
    axios
      .post("http://localhost:5000/api/v1/ml/pcos", {
        age,
        weight,
        height,
        BMI,
                ...
                <div class="infoDiabetic">
                  ...
                  <div class="preventDiabetes">
                    <p>
                      ...
                      hormonal condition in reproductive age women. It usually
                      affects up to 10% of women. PCOS can’t be prevented
                      entirely because most cases are genetically acquired,
                      though it doesn't necessarily mean you have PCOS since it
                      may only develop if other risk factors are present in some
                      cases
                    </p>

                    <p>
                      Your lifestyle habits greatly contribute to the
                      development of the disease. All women are encouraged to do
                    ...
                    <ul>
                      ...
                      <li>Manage stress</li>
                      <li>
                        Women with infertility, irregular periods or abnormal
                        hair growth should see a physician.
                      </li>
                    </ul>
                    <a href="https://www.openaccessgovernment.org/everything-to-know-about-pcos/74236/">
                      know more...
                    </a>
                  </div>
                </div>
              ...
              return (
                <div class="infoDiabetic">
                  ...
                  <div class="preventDiabetes">
                    ...
                    <p>
                      Good management of PCOS can greatly reduce the symptoms
                    ...
                    <ul>
                      ...
                      <li>
                        assisting with fertility and improving pregnancy
                    ...
                    <a href="https://www.jeanhailes.org.au/health-a-z/pcos/management-treatment">
                      know more...
                    </a>
                  </div>
                </div>

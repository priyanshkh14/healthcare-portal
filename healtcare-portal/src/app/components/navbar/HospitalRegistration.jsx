...
const HospitalRegistration = () => {
  ...
  const clickHandler = async () => {
    ...
    axios
      .post('http://localhost:5000/api/v1/hospitals/request', {
        name,
        email,
        phone,
        address,
  ...
  return (
    <>
      ...
      <div className="container2 mt-5">
        <h1 className="heading pt-2">Hospital Registration</h1>
          ...
          <div className="signup-content">
            <div className="signup-form">
              {error.length === 0 ? null : (
                error.map((key, value) => (
                  <p
                    style={{ color: 'red', fontSize: '12px', display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '60%', marginBottom: '-1px' }}
                  >

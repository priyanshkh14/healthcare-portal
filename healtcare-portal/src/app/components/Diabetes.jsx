...
export default function Diabetes() {
  ...
  var questions = [
    ...
    {
      question: 'Have you smoked at least 100 cigarettes in your entire life? [Note: 5 packs = 100 cigarettes](Yes/No)',
      option: {},
      type: 'text',
      name: 'smoker',
    },
    ...
    {
      question: 'physical activity in past 30 days - not including job(Yes/No)',
      option: {},
      type: 'text',
      name: 'phyAct',
    },
    ...
    {
      question: 'Heavy drinkers (adult men having more than 14 drinks per week and adult women having more than 7 drinks per week)(Yes/No)',
      option: {},
      type: 'text',
      name: 'heavyAlcohol',
    },
    {
      question: 'Would you say that in general your health is: (scale 1-5 => 1 = excellent 2 = very good 3 = good 4 = fair 5 = poor)',
      option: {},
      type: 'text',
      name: 'genHlt',
    },
    {
      question: 'Now thinking about your mental health, which includes stress, depression, and problems with emotions, for how many days it has been bad in past 30days',
      option: {},
      type: 'text',
      name: 'menHlt',
    },
    {
      question: 'Now thinking about your physical health, which includes physical illness and injury, for how many days during the past 30 days you have been ill',
      option: {},
      type: 'text',
      name: 'phyHlt',
    },
  ...
  function submitHandler() {
    ...
    formData.age = Math.floor((formData.age - 18) / 5) + 1;

    const { highBp, highCol, checkCol, smoker, stroke, phyAct, fruits, heavyAlcohol, genHlt, menHlt, phyHlt, diffWlk, gender, age } = formData;

    axios
      .post('http://localhost:5000/api/v1/ml/diabetes', {
        highBp,
        highCol,
        checkCol,
        BMI,
    ...
    <>
      {displayResult ? (
        <>
          ...
          {result.map((key, val) => {
            return (
              <div className="infoDiabetic" key={val}>
                {key === 0 ? (
                  <>
                    <h2 className="text-green-500 font-bebas-neue text-5xl">You're not diabetic</h2>
                    <div className="preventDiabetes">
                      <h6>You need to improve your daily lifestyle to keep yourself away from the risk of diabetes.</h6>
                      <ul>
                        <li>Reduce your total carb intake</li>
                        <li>Exercise Regularly</li>
                        <li>Drink water as your primary beverage</li>
                        <li>Try to lose excess weight</li>
                        <li>Quit smoking</li>
                        <li>Reduce your portion sizes</li>
                        <li>Cut back on sedentary behaviors</li>
                  ...
                  <>
                    <h2 className="text-orange-500 font-bebas-neue text-5xl">You're Pre-diabetic</h2>
                    <div className="preventDiabetes">
                      <h4>Is prediabetes reversible?</h4>
                      <p>Absolutely! You can turn back your prediabetes by adopting lifestyle changes, including:</p>
                      <ul>
                        ...
                        <li>Choose the right beverages. Don't drink sweetened beverages and always stay hydrated</li>
                        <li>Avoid certain foods like trans-fats, fried food, high calorie, and high-fat foods</li>
                  ...
                  <>
                    <h2 className="text-red-500 font-bebas-neue text-5xl">You're Diabetic</h2>
                    <div className="preventDiabetes">
                      <h5>
        ...
        <div className="fullFrame">
          <div className="heading mt-3">Diabetes Prediction</div>
          <hr className="w-30 bg-F49F0A border-3"></hr>

          <div className="center">
            <div id="register" className="shadow-md p-6 transition-transform duration-100 ease-in-out">
              <div className="flex flex-col">
                <div className="flex flex-row customLabel items-start">
                  <h1 className="text-xs mr-2">{pos + 1 + '/' + questions.length}</h1>
                ...
                <div className="flex flex-row">
                  <input
                    ...
                    value={buttonClick ? data : ''}
                    onChange={handleChange}
                    type={questions[pos].type}
                  />
                ...
                {submitButton ? (
                  ...
                  <button className="customSubmitButton" onClick={submitHandler}>
                    SUBMIT
                  </button>
                )}
              </div>

...
export default function Diabetes() {
  ...
  var questions = [
    {
      question: "Do you have high BP (Yes/No)",
      option: {},
      type: "text",
      name: "highBp",
    },
    {
      question: "Do you have high Cholestrol (Yes/No)",
      option: {},
      type: "text",
      name: "highCol",
    },
    {
      question: "Have you checked your cholestorl in last 5 years(Yes/No)?",
      option: {},
      type: "email",
      name: "checkCol",
    },
    ...
    {
      question: "Do you ever had stroke (Yes/No)",
      option: {},
      type: "text",
      name: "stroke",
    },
    ...
    {
      question: "Consume Fruit 1 or more times per day (Yes/No)",
      option: {},
      type: "text",
      name: "fruits",
    },
    ...
    {
      question:
        "Heavy drinkers (adult men having more than 14 drinks per week and adult women having more than 7 drinks per week)(Yes/No)",
      option: {},
      type: "text",
      name: "heavyAlcohol",
    },
    ...
    {
      question:
        "Now thinking about your mental health, which includes stress, depression, and problems with emotions, for how many days it has been bad in past 30days",
      option: {},
      type: "text",
      name: "menHlt",
    },
    {
      question:
        "Now thinking about your physical health, which includes physical illness and injury, for how many days during the past 30 days you have been ill",
      option: {},
      type: "text",
      name: "phyHlt",
    },
            ...
            if (key === 0) {
              return (
                <div class="infoDiabetic">
                  ...
                  <div class="preventDiabetes">
                    ...
                    <a href="https://www.healthline.com/nutrition/prevent-diabetes#8.-Follow-a-high-fiber-diet">
                      read more...
                    </a>
                  </div>
                </div>
              ...
              return (
                <div class="infoDiabetic">
                  ...
                  <div class="preventDiabetes">
                    ...
                    Absolutely! You can turn back your prediabetes by adopting
                    ...
                    <ul>
                      ...
                      <li>
                        Choose the right beverages. Don't drink sweetend
                        beverages and always stay hydrated
                      </li>
                      <li>
                        Avoid certain food like trans-fats,fried food,high
                        calorie and high fat foods{" "}
                      </li>
                      <li> Shed a few pounds. </li>
                    </ul>
                    <p>
                      note ** We recommend you to visit your doctor for
                      necessary medication and proper guidance
                    </p>
                    <a href="https://www.cdc.gov/diabetes/basics/prediabetes.html">
                      read more...
                    </a>
                  </div>
                </div>
              ...
              return (
                <div class="infoDiabetic">
                  ...
                  <div class="preventDiabetes">
                    <h5>
                      Diabetes management requires awareness. Know what makes
                      your blood sugar level rise and fall — and how to control
                      these day-to-day factors.
                    </h5>
                    <p>Food</p>
                    <ul>
                      <li>
                    ...
                    <p>
                      note ** We recommend you to visit your doctor for
                      necessary medicine and proper guidance
                    </p>
            ...
            <div id="register">
              <div class="d-flex flex-column">
                <div class="d-flex flex-row customLabel align-items-start">
                  <h1 style={{ fontSize: "12px", marginRight: "10px" }}>
                    {pos + 1 + "/" + questions.length}
                  </h1>
                  <label class="customLabel">{questions[pos].question}</label>
                </div>
                ...
                {submitButton ? (
                  ...
                  <button class="customSubmitButton" onClick={submitHandler}>
                    SUBMIT
                  </button>
                )}
              </div>
